...
#define STRING_VERSION_CONFIG_H "2017-12-27" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "Adam Jump" //Who made the changes.
...
#define HOMING_FEEDRATE {50*30, 50*30, 4*60, 0}  // set the homing speeds (mm/min)
